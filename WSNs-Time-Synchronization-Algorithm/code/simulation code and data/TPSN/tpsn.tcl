...
set val(rp)             tpsn                     ;# routing protocol
...
set opt(seed)         0.0
set addr ./Peleus_time_sync/tpsn
# ======================================================================
# Main Program
# ======================================================================
...
set tracefd [open ./Peleus_time_sync/tpsn/tpsn.tr w]
$ns_ trace-all $tracefd

set namtrace    [open ./Peleus_time_sync/tpsn/tpsn.nam w]
...
#	exec gawk -f $addr/broadcast.awk $addr/tpsn.tr >> $addr/broadcast.out
#	exec gawk -f $addr/energy.awk $addr/tpsn.tr >> $addr/energy.out
#	exec gawk -f $addr/error.awk $addr/error.tr > $addr/error.out
#	exec gawk -f $addr/errorl.awk $addr/error.tr > $addr/errorl.out	
#	exec nam ./Peleus_time_sync/tpsn/tpsn.nam
	exit 0
} 
