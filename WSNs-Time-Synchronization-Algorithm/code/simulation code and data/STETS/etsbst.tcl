...
set val(rp)             etsbst                     ;# routing protocol
...
set opt(seed)         0.0
set addr ./Peleus_time_sync/etsbst
# ======================================================================
# Main Program
# ======================================================================
...
set tracefd [open ./Peleus_time_sync/etsbst/etsbst.tr w]
$ns_ trace-all $tracefd

set namtrace    [open ./Peleus_time_sync/etsbst/etsbst.nam w]
...
#	exec gawk -f $addr/broadcast.awk $addr/etsbst.tr >> $addr/broadcast.out
#	exec gawk -f $addr/energy.awk $addr/etsbst.tr >> $addr/energy.out
#	exec gawk -f $addr/error.awk $addr/error.tr > $addr/error.out
#	exec gawk -f $addr/errorl.awk $addr/error.tr > $addr/errorl.out	
#	exec gawk -f $addr/errorb.awk $addr/error.tr > $addr/errorb.out	
#	exec gawk -f $addr/errorc.awk $addr/error.tr > $addr/errorc.out	
	
	exec nam ./Peleus_time_sync/etsbst/etsbst.nam
	exit 0
} 
if { [file exists $addr/error.tr] } { 
